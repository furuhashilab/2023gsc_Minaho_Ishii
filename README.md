...
## Abstract
本研究では、誰でも無料で利活用できるオープンソースのソフトウェア「OpenDroneMap」(https://www.opendronemap.org/) の普及を目的として、その概要と利用方法をグラレコにまとめ、日本への瀰漫を図り、Wikipediaページ(https://ja.wikipedia.org/wiki/OpenDroneMap) の日本語翻訳をする。
